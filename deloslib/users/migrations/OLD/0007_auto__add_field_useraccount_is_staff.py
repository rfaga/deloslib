...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAccount.is_staff'
        db.add_column(u'users_useraccount', 'is_staff',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAccount.is_staff'
        db.delete_column(u'users_useraccount', 'is_staff')
