...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'users_useraccount', (
            ...
            ('old_user_id', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('old_person_id', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('last_app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.DelosApplication'], null=True)),
        ))
