...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserAccount.old_user_id'
        db.delete_column(u'users_useraccount', 'old_user_id')

        # Deleting field 'UserAccount.old_person_id'
        db.delete_column(u'users_useraccount', 'old_person_id')

        # Adding field 'UserAccount.uspdigital'
        db.add_column(u'users_useraccount', 'uspdigital',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserAccount.phone'
        db.add_column(u'users_useraccount', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserAccount.alternate_email'
        db.add_column(u'users_useraccount', 'alternate_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=550, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserAccount.old_user_id'
        db.add_column(u'users_useraccount', 'old_user_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'UserAccount.old_person_id'
        db.add_column(u'users_useraccount', 'old_person_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Deleting field 'UserAccount.uspdigital'
        db.delete_column(u'users_useraccount', 'uspdigital')

        # Deleting field 'UserAccount.phone'
        db.delete_column(u'users_useraccount', 'phone')

        # Deleting field 'UserAccount.alternate_email'
        db.delete_column(u'users_useraccount', 'alternate_email')
    ...
    models = {
        ...
        u'users.useraccount': {
            ...
            'alternate_email': ('django.db.models.fields.EmailField', [], {'max_length': '550', 'null': 'True', 'blank': 'True'}),
            ...
            'uspdigital': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        }
    }
